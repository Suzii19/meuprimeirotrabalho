...
const tempFahr = parseFloat(prompt("Digite a temperatura de graus fahrenheit:"));
const fahrenheitToCelcius = ((tempFahr-32)*5)/9;
alert(`A temperatura de $(tempFahr)F convertido para Celsius eh de ${fahrenheitToCelcius.toFixed(2)}`);
console.log(fahrenheitToCelcius);